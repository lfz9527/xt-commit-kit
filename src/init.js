...
function detectPackageManager(projectRoot) {
  const checks = [
    { name: 'pnpm', file: 'pnpm-lock.yaml', installCmd: 'pnpm add -D', commitCmd: 'commit-kit-cz' },
    { name: 'yarn', file: 'yarn.lock', installCmd: 'yarn add -D', commitCmd: 'commit-kit-cz' },
    { name: 'bun', file: 'bun.lockb', installCmd: 'bun add -D', commitCmd: 'commit-kit-cz' },
    { name: 'npm', file: 'package-lock.json', installCmd: 'npm install -D', commitCmd: 'commit-kit-cz' },
  ];
  ...
  return { name: 'npm', installCmd: 'npm install -D', commitCmd: 'commit-kit-cz' };
}
